        ...
        <div className="mt-16 space-y-16">
          {projects.map((project, projectIdx) => (
            <Link
              ...
              className="flex flex-col-reverse overflow-hidden rounded-lg border-2 border-slate-900
                            p-8 transition duration-150 ease-in-out
                            hover:border-glow-600 hover:shadow-lg lg:grid lg:grid-cols-12  lg:gap-x-8"

    ...
    return (
        ...
        focus:border-gray bg-transparent"
            ...
            <input
                type="submit"
                value="send request"
                className="mt-8 font-medium inline-block capitalize text-lg sm:text-xl py-2 sm:py-3 px-6 sm:px-8 border-2 border-solid border-dark rounded cursor-pointer"
            />
        </form>
    );
}

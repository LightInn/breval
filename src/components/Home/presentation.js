					...
					<div className="grid grid-cols-1 gap-y-16 lg:grid-cols-2 lg:grid-rows-[auto_1fr] lg:gap-y-12">
						...
						<div className="flex h-full flex-col items-start justify-center lg:order-first lg:row-span-2">
							...
							<div className="mt-6 space-y-7 text-base font-bold text-slate-900">
								<p>
									→ CTO of the start-up{' '}
									<a className="text-glow-700" href="https://formenu.fr">
										ForMenu
									</a>
									<br />→ Co-founder of{' '}
									<a className="text-glow-700" href="https://my-makeup.fr">
										My-Makeup
									</a>
									, a platform to reference makeup artists
									<br />→ Co-founder of{' '}
									<a className="text-glow-700" href="https://artriste.cc">
										Artriste
									</a>
									, an e-commerce website for art
									<br />→ Co-founder of{' '}
									<a className="text-glow-700" href="https://forhives.fr">
										ForHives
									</a>
									, the hub to our bees
								</p>

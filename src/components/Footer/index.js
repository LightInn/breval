...
const Footer = () => {
	return (
		<footer className="z-20 mt-8 flex flex-col items-center rounded-t-2xl bg-accent text-black">
			<div className="border-light relative mt-4 flex w-full flex-col items-center justify-between border-t border-solid px-8 py-2 font-medium md:mt-8 md:flex-row md:py-6">

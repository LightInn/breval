...
const BlogLayoutThree = ({ blog }) => {
	return (
		<div className="text-slate-800 dark:text-slate-100 group flex flex-col items-center">
			<Link
			...
			<div className="mt-4 flex w-full flex-col">
				<span className="text-xs font-semibold uppercase text-accent dark:text-pink-400 sm:text-sm">
					{blog.tags[0]}
				</span>
				...
				<span className="text-sm font-semibold capitalize text-gray-600 dark:text-gray-400 sm:text-base">

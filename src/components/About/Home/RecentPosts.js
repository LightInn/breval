	...
	return (
		<section className="mt-16 flex w-full flex-col items-center justify-center px-5 sm:mt-24 sm:px-10 md:mt-32 md:px-24 sxl:px-32">
			<div className="flex w-full justify-between">
				<h2 className="text-slate-800 dark:text-slate-100 inline-block w-fit text-2xl font-bold capitalize md:text-4xl font-display">
					Recent Posts
				</h2>
				<Link
					className="inline-block text-base font-medium text-accent dark:text-pink-400 underline underline-offset-2 md:text-lg"

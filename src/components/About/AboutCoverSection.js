...
import {GithubIcon, DiscordIcon, LinkedinIcon, TwitterIcon, EmailIcon} from "@/components/Icons";
            ...
            <div className="p-20 w-full h-full flex justify-center items-center backdrop-blur-lg">
                ...
                <div className="flex flex-col justify-center items-center md:items-end w-full md:w-1/4 ">
                    ...
                    <div className="flex w-full h-full gap-2 mt-20 p-2 ">
                        <Link href="https://github.com/LightInn/" className="w-full h-full" target="_blank" rel="noreferrer noopener" aria-label="Github" title="Github">
                            <GithubIcon
                                className="w-[30px] rounded-2xl bg-dynamic-vibrant-light hover:bg-dynamic-muted-light p-2 md:message-bulle"/>
                            {/*<DribbbleIcon*/}
                            {/*    className="w-[30px] rounded-2xl bg-dynamic-vibrant-light hover:bg-dynamic-muted-light p-2 md:message-bulle"/>*/}
                        </Link>
                        <Link href="https://www.linkedin.com/in/breval-lefloch/" className="w-full h-full" target="_blank" rel="noreferrer noopener" aria-label="Linkedin" title="Linkedin">
                            <LinkedinIcon
                                className="w-[30px] rounded-2xl bg-dynamic-vibrant-light hover:bg-dynamic-muted-light p-2 md:message-bulle"/>
                        </Link>
                        <Link href="https://twitter.com/Unknow429523025" className="w-full h-full" target="_blank" rel="noreferrer noopener" aria-label="Twitter" title="Twitter">
                            <TwitterIcon
                                className="w-[30px] rounded-2xl bg-dynamic-vibrant-light hover:bg-dynamic-muted-light p-2 md:message-bulle"/>
                        </Link>
                        <Link href="mailto:breval.lefloch@gmail.com" className="w-full h-full" target="_blank" rel="noreferrer noopener" aria-label="Email" title="Email">
                            <EmailIcon
                                className="w-[30px] rounded-2xl bg-dynamic-vibrant-light hover:bg-dynamic-muted-light p-2 md:message-bulle"/>
                        </Link>
                        <Link href="https://discordapp.com/users/232064075553701888"  target="_blank" rel="noreferrer noopener" aria-label="Discord" title="Discord"

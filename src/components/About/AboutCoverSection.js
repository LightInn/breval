...
const AboutCoverSection = ({background = null}) => {
    return (
        <section
            className="w-screen h-screen border-b-2 border-solid border-dark flex flex-col md:flex-row items-center justify-center text-dark bg-dynamic-bg bg-cover ">

...
export function ReloadCTA({ setReload = null }) {
	return (
		<div className="absolute right-0 top-0 z-20 mt-14 flex flex-col items-center justify-evenly gap-8 p-4 xl:mt-0 xl:gap-10 xl:p-16">
			...
			<button
				aria-label="Reload"
				className="animated-image message-bulle rounded-full bg-dynamic-vibrant-light p-6 no-underline hover:rotate-180"
					...
					<g id="SVGRepo_iconCarrier">
						<g id="_34-Update" transform="translate(-3072,-6144)">
							<g id="g2057" transform="translate(3328,6333.5)">
								<path
									className="stroke-4 fill-dynamic-muted-dark"

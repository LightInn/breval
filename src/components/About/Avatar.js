...
export default function Avatar() {
    ...
    return (
        <>
            ...
            <svg className="max-w-[50vw] max-h-[80vh] overflow-visible motion-reduce:hidden" viewBox="0 0 687 834"
                 fill="none"
                ...
                <g id="avatar">
                    ...
                    <g id="particles">
                        ...
                        <circle id="p5" cx="523.469" cy="636.416" r="14.3783"
                                ...
                                fill="white"/>
                        <circle id="p4_2" cx="455.696" cy="669.696" r="5.6263"
                                transform="rotate(-160.256 455.696 669.696)"
                                fill="white"/>
                        <circle id="p3_2" cx="375.696" cy="546.696" r="3.01429"
                                transform="rotate(-160.256 375.696 546.696)"
                                fill="white"/>
                        <circle id="p2_2" cx="214.355" cy="544.355" r="2.06736"
                                transform="rotate(-160.256 214.355 544.355)"
                                fill="white"/>
                        <circle id="p1_2" cx="418.494" cy="694.494" r="9.37716"

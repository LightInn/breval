...
export function Playground() {
    return (<div className="flex flex-col items-center justify-center w-full h-screen space-y-8">
        <div className="text-center p-5 bg-dynamic-vibrant-light rounded-lg shadow-xl">
            <p className="text-lg font-bold text-gray-800">Everything looks oddly colored here, doesn&apos;t it?</p>

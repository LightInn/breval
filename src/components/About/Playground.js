	...
	return (
		<div className="flex min-h-screen w-full flex-col items-center justify-center space-y-12 px-8 py-4 md:ml-20">
			<div className="rounded-lg bg-dynamic-vibrant-light p-4 text-center shadow-xl">
				...
				<p className="text-gray-700">Well, that&apos;s because I didn&apos;t choose the colors!</p>
				<p className="text-gray-700">
					The color theme is generated dynamically from the background image ⭐
				</p>
				<p className="text-gray-700">You can reload the page to try with a different image and theme!</p>
			</div>

			<div className="p-4">
				<p className="text-xl font-semibold text-slate-800 dark:text-slate-100 font-display">Actual Theme</p>
				...
				<div className="flex flex-col items-center justify-center gap-2 md:flex-row">
					...
					<p className="text-xl font-semibold text-slate-800 dark:text-slate-100 md:hidden font-display">
						Based on Image
					</p>
					<Image
			...
			<button
				className="mt-5 rounded-full bg-dynamic-vibrant px-6 py-3 font-bold text-white shadow-lg transition-colors duration-300 ease-in-out hover:bg-dynamic-vibrant-dark hover:text-white focus:outline-none focus:ring-2 focus:ring-pink-500 focus:ring-offset-2"

		...
		<section className="flex w-full flex-col items-center bg-gradient-to-r from-dynamic-muted-light to-dynamic-muted py-8 md:pl-20">
			...
			<ul className="mb-8 flex w-full flex-wrap justify-center gap-4 p-10">
				{SkillList.map((skill, index) => (
					<li
						className="rounded-full bg-white px-4 py-2 text-sm font-semibold text-dynamic-muted-dark shadow transition duration-200 ease-in-out hover:bg-purple-100 md:text-base lg:text-lg"
						key={index}
					>
						{skill}
					</li>

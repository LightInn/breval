...
export default function Projects() {
	...
	const projects = [
		{
			title: 'ForMenu',
			description:
				'A SaaS platform for dematerialized menus in restaurants with QR code generation and analytics.',
		...
		},
		{
			title: 'My-Makeup',
			description:
				'A networking site for professional makeup artists to showcase their work and connect with clients.',
		...
		},
		{
			title: 'Artriste',
			description:
				'An e-commerce website for art and artists with secure payment processing.',
		...
		},
		{
			title: 'ForHives',
			description:
				'A hub for bee-related projects and initiatives with interactive maps.',
	...
	return (
		<section id="projects" className="relative py-20">
			<div className="from-background/0 via-primary/5 to-background/0 absolute inset-0 bg-gradient-to-b" />
				...
				>
					{projects.map((project, index) => (
						<motion.div key={index} variants={item}>
							<Card
								className={`border-primary/20 bg-card/60 hover:border-primary/50 h-full overflow-hidden backdrop-blur-sm transition-all duration-300 ${project.featured ? 'md:col-span-2' : ''}`}
							>
								<div
								...
								>
									...
									{project.featured && (
										<div className="absolute left-4 top-4">
											<Badge className="bg-primary text-primary-foreground pixel-corners">
												Featured
											</Badge>
										</div>
									)}

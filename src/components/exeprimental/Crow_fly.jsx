...
export function FlyingCrow({step, test}, props) {
    ...
    const group = useRef()
    const {nodes, materials, animations} = useGLTF('/3D/crow_fly-transformed.glb')
        ...
        <group ref={group} {...props} dispose={null}>
            <group name="Scene">
                <group name="flyingCrow">
                    <group name="Bone">
                        <mesh name="crow" geometry={nodes.crow.geometry} material={materials.crow}
                              position={[-0.27, -0.228, -39.947]} rotation={[-0.028, 0, -0.725]} scale={0.881}/>
                    </group>
                </group>
            </group>
        </group>

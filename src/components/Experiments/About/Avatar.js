...
export default function Avatar() {
	...
	return (
		<>
			...
			<svg
				className="max-h-[80vh] max-w-[50vw] overflow-visible motion-reduce:hidden"
				fill="none"
				viewBox="0 0 687 900"
				xmlns="http://www.w3.org/2000/svg"
			>
				<g clipPath="url(#clip0_7_105)" id="avatar">
					<path
					...
					/>
					<g id="particles">
						<circle cx="148.5" cy="670.5" fill="white" id="p24" r="7" />
						<circle
							cx="220.676"
							cy="656.676"
							fill="white"
					...
					<g id="head">
						...
						<g id="eyeL">
							<circle cx="287" cy="203" fill="#74341C" id="pupilleL" r="11" />
							<circle cx="292" cy="198" fill="white" id="shineL" r="3" />
						</g>
						<g id="eyeR">
							<circle cx="410" cy="201" fill="#74341C" id="pupilleR" r="11" />
							<circle cx="414" cy="196" fill="white" id="shineR" r="3" />
						</g>
						<g id="Mia">
							<g id="miaEar">
								<path
				...
				<defs>
					<clipPath id="clip0_7_105">
						<rect fill="white" height="834" width="687" />
					</clipPath>
				</defs>
			</svg>
		</>

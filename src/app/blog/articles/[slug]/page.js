...
export async function generateMetadata({params}) {
    ...
    if (blog.image) {
        imageList = typeof blog.image === "string" ? [siteMetadata.siteUrl + blog.image] : blog.image;
    }
...
export default async function BlogPage({params}) {
    ...
    let imageList = [siteMetadata.socialBanner];
    if (blog.image) {
        imageList = typeof blog.image.filePath === "string" ? [siteMetadata.siteUrl + blog.image] : blog.image;
    }
    ...
    const jsonLd = {
        ...
        author: [{
            "@type": "Person", name: blog?.author ? [blog.author] : siteMetadata.author, url: siteMetadata.twitter,
        },],
    };

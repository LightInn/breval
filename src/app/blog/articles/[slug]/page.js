        ...
        <>
            ...
            <article>
                <div className="mb-8 text-center relative w-full h-[70vh] ">
                    <div
                        className="w-full h-full z-10 flex flex-col items-center justify-center absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 p-0 md:p-20">
                        <div
                            className="flex flex-col justify-center gap-8 backdrop-blur-xl bg-black/40 w-full h-full rounded-2xl md:max-w-[70vw]  ">
                            <div>
                                <Tag
                                    name={blog.tags[0]}

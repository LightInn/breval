  ...
  const artExperiments = [
    {
      ...
      description: "Exploring procedural generation with WebGL and fragment shaders.",
    ...
    },
    {
      ...
      description: "Audio-reactive visuals that respond to music and sound input.",
    ...
    },
    {
      ...
      description: "Artwork generated using machine learning and neural style transfer.",
    ...
    },
    {
      ...
      description: "3D voxel-based digital sculptures with interactive elements.",
      tags: ["Voxel", "3D", "WebGL"],
      image: "/placeholder.svg?height=300&width=500",
      demo: "#",
    },
          ...
          <div className="container mx-auto px-4">
            <motion.div
              ...
              <p className="text-muted-foreground max-w-2xl mx-auto">
                A collection of creative coding experiments, generative art, and interactive digital experiences. These
                projects explore the intersection of code, art, and human interaction.
              </p>
            </motion.div>
            ...
            <motion.div
              ...
              {artExperiments.map((experiment, index) => (
                <motion.div key={index} variants={item}>
                  <Card
                    className="overflow-hidden border-primary/20 bg-gray-900/60 backdrop-blur-sm hover:border-primary/50 transition-all duration-300 h-full">
                    <div className="relative h-48 overflow-hidden">
                      <div className="absolute inset-0 dithered opacity-30"></div>
                      <img
                        src={experiment.image || "/placeholder.svg"}
                        alt={experiment.title}
                        className="w-full h-full object-cover" />
                      <div
                        className="absolute inset-0 bg-gradient-to-t from-gray-900 to-transparent"></div>

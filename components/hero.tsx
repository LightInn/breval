    ...
    return (
        <div className="relative z-20 flex h-screen w-screen items-center justify-center">
            ...
            <div
                ...
                <div className="clear-both m-0 h-[100vh] w-[100vw] relative max-w-[100vw] overflow-x-hidden p-0 video-background">
                    <div className="area ">
                    ...
                    <iframe
                        className={
                            'absolute left-0 top-0 w-full h-full object-cover object-center ' +
                            'mix-difference -z-10 block bg-slate-900 object-cover opacity-75 animate-video'
                        }
                        id="topHeroVideo" src="https://player.vimeo.com/video/879007060?background=1" width="1920"
                        height="1080" frameBorder="0" allow="autoplay" data-ready="true" allowFullScreen></iframe>
                </div>
            </div>

...
export function Presentation() {
    return (
        <section
			...
			transform flex-col flex-wrap items-center justify-center bg-sakura-tree bg-cover
                    ...
                    <div className="grid grid-cols-1 gap-y-16 lg:grid-cols-2 lg:grid-rows-[auto_1fr] lg:gap-y-12">
                        <div className="lg:pl-20">
                            <div className="flex max-w-xs px-2.5 lg:max-w-none">
                                ...
                                >
                                    <PopCard height={500} width={300} className={'rounded-2xl'}
                                ...
                                <div
                                    className={
                                        'animated-image-bg absolute h-[250px] w-[250px] rotate-2 rounded-2xl bg-glow-500 p-10 shadow-2xl hidden sm:block'
                                    }
                                ></div>
                            </div>
                        </div>
